...
public class MaterialLoadingView extends BaseLoadingView {
	...
	protected void setLetvVisibility(int visibility) {
		...
		final ImageView loadingImageView = (ImageView) findViewById(ReUtils.getId(context, "letv_skin_v4_letv_iv_loading"));
...
//			loadingImageView.setImageResource(ReUtils.getId(context, "letv_skin_v4_letv_iv_loading_image"));
//			String url = uiPlayContext.getCoverConfig().getLoadingConfig().getPicUrl();
//			loadingImageView.setImageUrl(url, imageLoader);
			post(new Runnable() {
